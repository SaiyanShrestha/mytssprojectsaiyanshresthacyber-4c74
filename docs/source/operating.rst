[mytssprojectsaiyanshresthacyber-4c74] Operating Details
====================================

Generated On: 2024-10-17 20:00:45 UTC
...
.. important::
   ...
   **not be valid if your [mytssprojectsaiyanshresthacyber-4c74] container is NOT running**.

.. tip::
   You must have your [mytssprojectsaiyanshresthacyber-4c74] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env READTHEDOCS=<Enter your readthedocs token>  \-\-env EXTERNALPORT=35251  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME=saiyanshrestha  \-\-env GITPASSWORD=<Enter personal access token>  \-\-env DOCKERUSERNAME=saiyanshrestha  \-\-env DOCKERPASSWORD=<Enter your docker hub password>  \-\-env MQTTUSERNAME=saiyanshrestha  \-\-env MQTTPASSWORD=<Enter your mqtt password>  \-\-env KAFKACLOUDUSERNAME=  \-\-env KAFKACLOUDPASSWORD=<Enter your API secret>  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   saiyanshrestha/mytssprojectsaiyanshresthacyber-4c74-amd64 (https://hub.docker.com/r/saiyanshrestha/mytssprojectsaiyanshresthacyber-4c74-amd64)
...
.. important::
   docker run -d -p 55455:55455 -p 53073:53073 -p 54873:54873 \-\-env TSS=0 \-\-env SOLUTIONNAME=mytssprojectsaiyanshresthacyber-4c74 \-\-env SOLUTIONDAG=solution_preprocessing_dag-mytssprojectsaiyanshresthacyber-4c74 \-\-env GITUSERNAME=saiyanshrestha \-\-env GITPASSWORD=<Enter Github Password>  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi.git \-\-env SOLUTIONEXTERNALPORT=55455 \-\-env READTHEDOCS=<Enter Readthedocs token> \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53073  \-\-env SOLUTIONVIPERVIZPORT=54873 \-\-env DOCKERUSERNAME=saiyanshrestha  \-\-env EXTERNALPORT=35251 \-\-env KAFKACLOUDUSERNAME= \-\-env KAFKACLOUDPASSWORD=<Enter API secret>  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME=saiyanshrestha \-\-env MQTTPASSWORD=<Enter mqtt password>  \-\-env AIRFLOWPORT=9000 saiyanshrestha/mytssprojectsaiyanshresthacyber-4c74-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=54873
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=55455
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - saiyanshrestha/mytssprojectsaiyanshresthacyber-4c74-amd64
...
It can be accessed by entering: http://localhost:53073
...
.. important::
   http://localhost:54873/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54873/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:54873/<html file>
...
[mytssprojectsaiyanshresthacyber-4c74] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/saiyanshrestha/rashpberrypi/tree/main/tml-airflow/dags/tml-solutions/mytssprojectsaiyanshresthacyber-4c74
...
.. important::
   https://mytssprojectsaiyanshresthacyber-4c74.readthedocs.io
...
.. important::
   solution_preprocessing_dag-mytssprojectsaiyanshresthacyber-4c74
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55455, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42689, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42347, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34597, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33409, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33837, HPDEHOST=127.0.1.1, HPDEPORT=41729, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41905

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4705-mytssprojectsaiyanshresthacyber-4c74,solution_preprocessing_dag-mytssprojectsaiyanshresthacyber-4c74, python-preprocess-6203-mytssprojectsaiyanshresthacyber-4c74,solution_preprocessing_dag-mytssprojectsaiyanshresthacyber-4c74, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
